...
{ re:
    { id: "get"
    , of: "ionify"
    , is: "ionify's resource [css,script,media,etc.] loader"
    , by: "Michael Lee, iskitz.net, @iskitz"
    , at: "2003.11.19-04.00...2016.03.11-08.00"
    , in: ["forest-hills.new-york.usa.earth", "san-jose.california.usa.earth"]
    },
  ...
  load:
    function load (ion)
      { (typeof ion != 'object') && (ion = {load:ion});
        ...
        var url         = ion.load
          ...
          ;
        then && (script.onload = function(){ +ion.then; });
        script.src = url;
